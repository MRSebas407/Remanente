...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-v0yn+8stqqtlz#542v$yp-fz=$y5qw+n^zv%b&tm(n=&^hj=p*')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'appiglesia'),
        'USER': os.environ.get('DB_USER', 'appiglesia'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'appiglesia'),
